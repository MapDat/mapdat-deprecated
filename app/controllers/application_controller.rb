...
class ApplicationController < ActionController::Base
 ...
 def authenticate_request!
   fail NotAuthenticatedError unless user_email_included_in_auth_token?
   @current_user = @connection.exec_query("SELECT * FROM users
                                           WHERE email = '#{decoded_auth_token[:email]}'")
 ...
 # ------------------------------------------------------------
 def user_email_included_in_auth_token?
   http_auth_token && decoded_auth_token && decoded_auth_token[:email]
 end
